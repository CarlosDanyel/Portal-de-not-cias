const portalDeNoticias = document.getElementById("paginaDeNoticias");

function ExibirNoticiasEtrocaNoHtml(noticias){
    portalDeNoticias.innerHTML = "";
    ...
    noticias.forEach(noticia => {
        ...
        <div class="svg-li">
          <span class="date">${noticia.publishedAt} - <span>${noticia.author}</span></span>
          <svg
            id="icon"
            width="25"
            height="25"
        ...
        <a href="${noticia.url}" class="link-noticia">
